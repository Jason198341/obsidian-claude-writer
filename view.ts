...
import { callClaude, getAuthStatus, claudeAuthLogout, claudeAuthLogin, detectTemplate, extractSectionHeaders, extractUsefulContent, COMMANDS, TONES, EXPLAIN_LEVELS, VIZ_SUGGEST_PROMPT, VIZ_GENERATE_PROMPT } from "./main";
    ...
    switch (s) {
      ...
      case "done":
        ...
        if (ar) {
          ...
          // All modes get all insert options
